...
impl PlayerState {
    ...
    pub(super) fn single_player_tables(&self) -> Result<SinglePlayerTables> {
        self.single_player_tables_with_workspace(&mut SPWorkspace::default())
    }

    pub(super) fn single_player_tables_with_workspace(
        &self,
        ...
        let mut max_ev_table = sp_calc.calc_with_workspace(
            init_state,
            can_discard,
            tsumos_left,
            cur_shanten,
